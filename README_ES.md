# AgenticSeek: Alternativa Privada y Local a M```sh
...
[![Visit AgenticSeek](https://img.shields.io/static/v1?label=Website&message=AgenticSeek&color=blue&style=flat-square)](https://ayushupadhyay.github.io/agenticSeek.html) ![License](https://img.shields.io/badge/license-GPL--3.0-green) [![GitHub stars](https://img.shields.io/github/stars/AyushUpadhyay/agenticSeek?style=social)](https://github.com/AyushUpadhyay/agenticSeek/stargazers)
...
```sh
git clone --depth 1 https://github.com/AyushUpadhyay/agenticSeek.git
...
[![Star History Chart](https://api.star-history.com/svg?repos=AyushUpadhyay/agenticSeek&type=Date)](https://www.star-history.com/#AyushUpadhyay/agenticSeek&Date)

## Mantenedores:

 > [Ayush Upadhyay](https://github.com/AyushUpadhyay) | Hecho por Ayush Upadhyay

## Agradecimientos Especiales:

 > [tcsenpai](https://github.com/tcsenpai) y [plitc](https://github.com/plitc) Por ayudar con la dockerización del backend
 > Inspiración original de [Fosowl](https://github.com/Fosowl)
